    ...
    def train_q_learning(self, env, episodes=2000, learning_rate_a=0.1, discount_factor_g=0.95,
        ...
        for episode in tqdm(range(episodes), desc="Training", unit="ep"):
            ...
            while not terminated and not truncated:
                current_position = tuple(obs['agent'])

                # Calcul du bonus pour nouvelle position visitée
                if current_position not in visited_positions:
                    reward_bonus = 1.0  # Bonus pour nouvelle position visitée
                ...
                # Ajout du bonus à la récompense
                reward += reward_bonus
